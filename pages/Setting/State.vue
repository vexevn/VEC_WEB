...
import dm_fixed_asset_state from "~/assets/scripts/objects/dm_fixed_asset_state";
...
export default {
  data() {
    return {
      ...
      tp: new TablePaging({
        title: "Tiêu đề",
        data: APIHelper.fixed_asset_state.GetList,
      ...
      form: new DefaultForm({
        ...
        ShowForm: (title, isAdd, obj) => {
          ...
          this.form.obj = new dm_fixed_asset_state(obj);
  ...
  methods: {
    ...
    Delete(row) {
      ShowConfirm({
        ...
        .then(() => {
          APIHelper.fixed_asset_state.Delete(row).then((re) => {
            this.LoadData();
