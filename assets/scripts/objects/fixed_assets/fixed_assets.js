              ...
              child: [
                ...
                new FormElement({
                  child: [
                    ...
                    this._formElements.Initial_Holder_Name.set(
                      (p) => (p.col = 6)
                    ),
                    this._formElements.Curent_Holder_Name.set(
                      (p) => (p.col = 6)
                    ),
                    this._formElements.Status.set((p) => (p.col = 8)),
                    new FormElement({
                      col: 4,
                      class: "Estimated",
                      child: [
                ...
                new FormElement({
                  child: [
                    ...
                    this._formElements.Type_id.set((p) => (p.col = 7)),
